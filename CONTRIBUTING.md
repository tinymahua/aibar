...
Welcome to `aibar` contributor's guide.
...
If you experience bugs or general issues with `aibar`, please have a look
...
You can help improve `aibar` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`aibar` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `aibar`'s files. While this mechanism can
...
```
conda create -n aibar python=3 six virtualenv pytest pytest-cov
conda activate aibar
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/aibar.git
   cd aibar
   ```
...
5. Install [pre-commit]:
   ...
   `aibar` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/aibar
[issue tracker]: https://github.com/<USERNAME>/aibar/issues
